...
#EDIT THE FOLLOWING:
$toAddress = "fikirliya@gmail.com";  //place your/your client's email address here
$toName = "fikirte Beyene"; //place your client's name here
$website = "Client Form";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h2>Thanks for yoyr interest in our web services.We will get back to yoy within 2 business days.</h2>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
